...
autoUpdater.on('update-available', info => {
  dialog.showMessageBox({
    type: 'info',
    title: 'Found Updates',
    message: 'An update for this software is available, do you want to update now and restart?',
    buttons: ['Yes', 'No'],
    cancelId: 1
  })
    .then(r => {
...
function initialize() {
  ...
  function createMainWindow () {
    ...
    const mainWindowOptions = {
      ...
      resizable: true,
      webPreferences: {
        backgroundThrottling: false, //TODO: Skip this if it doesn't affect performance
        nodeIntegration: true,
